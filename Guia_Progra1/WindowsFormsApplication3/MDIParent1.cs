...
namespace WindowsFormsApplication3
{
    public partial class MDIParent1 : Form
    {
        ...
        {
            Guia2Ejer1 hijo = new Guia2Ejer1();
            hijo.MdiParent = this;
            hijo.Show();
        }
        ...
        {
            Guia2Ejer2 hijo = new Guia2Ejer2();
            hijo.MdiParent = this;
            hijo.Show();
        }
        ...
        {
            Guia2Ejer3 hijo = new Guia2Ejer3();
            hijo.MdiParent = this;
            hijo.Show();
        }
    }
